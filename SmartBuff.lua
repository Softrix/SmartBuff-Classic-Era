...
SMARTBUFF_DATE			= "260123";
SMARTBUFF_VERSION       = "r41."..SMARTBUFF_DATE;
SMARTBUFF_VERSIONNR     = 11403;			-- max version
...
local cIgnoreClasses = { 10, 11, 12, 15, 17, 18 };
...
-- available sounds (14)        -- these need to be checked on classic.
local Sounds = { 1141, 8672, 7394, 8154, 3212, 8212, 8156, 7181, 8943, 3321, 3337, 7894, 7914, 8332 }
...
function SMARTBUFF_Options_Init(self)
  ...
  if (O.ToggleMsgError == nil) then O.ToggleMsgError = true; end
  ...
  if wowTOC > SMARTBUFF_VERSIONNR then
